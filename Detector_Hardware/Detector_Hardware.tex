...
In order to provide a structural skeleton for the detector and shield the photo sensitive sensors from external light sources the \sm s are all positioned inside a carbon fiber box.
...
A primitive layout is available which uses three \SI{1}{mm} thick carbon layers for the main sides.
