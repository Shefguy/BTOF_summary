...
In order to make the assumption that the boards are constructed homogeneously down its length we need to take the decreasing length of each channel transmission line into account.
Since this is a continuous length increase we are able to divide the total area covered by copper by 2 to receive 
